...
$(document).ready(function () {
	...
	var validateur = $("#formulaire").validator({
		lang: 'fr',
		offset: [-20, -20],
		position: 'top right',
		message: '<div><em/></div>',
	...
	/*$.tools.validator.fn(".chk_required", function(input, value) {
		console.log(input.find(':checkbox :checked'));
		return (input.find(':checkbox :checked'))? true : {     
			en: "Please check at least one checkbox",
			fr: "Il faut cocher au moins une option des cases &agrave; cocher."
		};
	});*/
	...
	$('.bazar_checkbox :checkbox :checked').click(function() {
